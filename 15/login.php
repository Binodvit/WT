...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT * FROM Consumer WHERE username = ?");
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
        ...
        <p class="text-center mt-4">Don't have an account? <a href="register.php" class="text-green-600 hover:underline">Register</a></p>
    </div>
</body>
</html>